    ...
    return (
        <AnimatePresence>
            {isScrolling?(
                ...
                animate="animate"
                exit="exit"
                className="ml-auto mr-auto md:fixed z-[9999] right-0 left-0 px-6 py-3 text-white bg-gray-400/40 top-5 rounded-3xl backdrop-blur w-fit">
                    <div className="items-center hidden gap-5 md:flex">
                        ...
                        <Link href="/login" className="px-3 py-2 text-white roundend-lg bg-secondary hover:bg-black"></Link>
                    </div>
                </motion.nav>
            ):(
