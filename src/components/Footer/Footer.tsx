            ...
            <div className='grid gap-8 grid-cols-2 md:grid-cols-[1fr,1fr,1fr,_400px] text-white'>
                ...
                <div className='md:text-right'>
                    ...
                    <div className='flex gap-4 mt-5 md:justify-end'>
                        <LiaYoutube className='text-3xl cursor-pointer' href='#YouTube'/>
                        <LiaInstagram className='text-3xl cursor-pointer' href='#Instagram'/>
                        <LiaLinkedinIn className='text-3xl cursor-pointer' href='#LinkedIn'/>
                        <LiaPinterestP className='text-3xl cursor-pointer' href='#Pinterest'/>
                    </div>
                </div>
            </div>           
        </div>
