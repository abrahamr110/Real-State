        ...
        <main className="max-w-5xl mx-auto">
            <div className="grid md:grid-cols-[70%,1fr] my-3 py-5">
                <div className="px-6">
                    ...
                    <Image src={`/assets/properties/${house.image}`} alt={`Casa en ${house.location}`} width={1200} height={1200} className="w-full h-auto rounded-xl" priority/>
